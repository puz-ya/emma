...
/////////////////////////////////////////////////////////////////////////////
void CClot::LoadFromFront(CFrontier *pFront, double dTgAng, double dKff, double dCeiling){
...
/////////////////////////////////////////////////////////////////////////////
double CClot::GetValue(Math::C2DPoint *pDP, FRONTINF inf, CFrontier *pFront){
...
void CClot::SetConstVal(double val)
{
	m_nType = 1;
	m_dVal = val;
}
